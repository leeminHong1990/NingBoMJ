...
var impRoomOperation = impGameRules.extend({
	...
	createRoom : function(player_num, pay_mode, win_num, round_num, king_num, is_agent) {
		cc.log("createRoom:",player_num, pay_mode, win_num, round_num, king_num, is_agent)
		this.baseCall("createRoom", player_num, pay_mode, win_num, round_num, king_num, is_agent);
	},
